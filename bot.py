...
TOOLBAR_BUTTONS = {
    BTN_FAVORITES, BTN_ADD, BTN_REMOVE, BTN_NEXT,
    BTN_LOOKUP, BTN_FAVALL, BTN_CLEARALL
}
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "Get notified 10 minutes before your favourite crop contest.\n\n"
